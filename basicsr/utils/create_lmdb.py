...
def create_lmdb_for_gopro():
    folder_path = '/Dataset/Deblurring/HIDE/input'
    lmdb_path = '/Dataset/Deblurring/HIDE/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/Dataset/Deblurring/HIDE/target'
    lmdb_path = '/Dataset/Deblurring/HIDE/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/Dataset/Deblurring/RealBlur_J/target'
    lmdb_path = '/Dataset/Deblurring/RealBlur_J/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/data/lifei/Dataset/Deblurring/RealBlur_J/input'
    lmdb_path = '/data/lifei/Dataset/Deblurring/RealBlur_J/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_rain13k():
    folder_path = '/Dataset/Rain13K/train/input'
    lmdb_path = '//Dataset/Rain13K/train/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/Dataset/Rain13K/train/target'
    lmdb_path = '/Dataset/Rain13K/train/target.lmdb'
