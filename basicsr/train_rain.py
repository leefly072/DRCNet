...
def create_train_val_dataloader(opt, logger):
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            for name in names:
                dataset_opt['dataroot_gt'] = os.path.join('/data/lifei/Dataset/Rain13K/test', name, 'target')
                dataset_opt['dataroot_lq'] = os.path.join('/data/lifei/Dataset/Rain13K/test', name, 'input')
